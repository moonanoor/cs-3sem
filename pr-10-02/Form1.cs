...
namespace pr_10_02
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            button1.Enabled = false; // ЗАкрываем доступ к кнопке «Погнали!»
            button2.Enabled = true; // Открываем доступ к кнопке «Сделать ставку».
        }
        ...
        int money_player_have = 100;
        private void button2_Click(object sender, EventArgs e)
        {

            if (money_player_have == 0)
            {
                System.Windows.Forms.MessageBox.Show("Ха, ты бедный !!!");
                Application.Exit();
            }
            if (numericUpDown1.Value > money_player_have)
            {
                System.Windows.Forms.MessageBox.Show("У вас нет столько деняк!!!/n Ставлю 1");
                numericUpDown1.Value = 1;
            }
            money_player_have = money_player_have - Convert.ToInt32(numericUpDown1.Value);
